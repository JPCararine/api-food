...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values
                                                                        ...
                                                                        ('Salada picante com carne grelhada', 'Salada de folhas com cortes finos de carne bovina grelhada', 87.20, 1, 2),
                                                                        ...
                                                                        ('Bife Ancho', 'Corte macio e suculento', 79, 1, 4),
                                                                        ('T-Bone', 'Corte com osso em T', 89, 1, 4),
                                                                        ('Sanduíche X-Tudo', 'Hambúrguer completo', 19, 1, 5),
                                                                        ('Espetinho de Cupim', 'Acompanha farinha e vinagrete', 8, 1, 6);