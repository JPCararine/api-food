...
delete from usuario_restaurante;
...
insert into produto (nome, descricao, preco, restaurante_id) values ('Porco com molho agridoce', 'Deliciosa carne suína ao molho especial', 78.90,  1);
insert into produto (nome, descricao, preco,  restaurante_id) values ('Camarão tailandês', '16 camarões grandes ao molho picante', 110,  1);

insert into produto (nome, descricao, preco,  restaurante_id) values ('Salada picante com carne grelhada', 'Salada de folhas com cortes finos de carne bovina grelhada e nosso molho especial de pimenta vermelha', 87.20,  2);

insert into produto (nome, descricao, preco,  restaurante_id) values ('Garlic Naan', 'Pão tradicional indiano com cobertura de alho', 21,  3);
insert into produto (nome, descricao, preco,  restaurante_id) values ('Murg Curry', 'Cubos de frango preparados com molho curry e especiarias', 43,  3);

insert into produto (nome, descricao, preco,  restaurante_id) values ('Bife Ancho', 'Corte macio e suculento, com dois dedos de espessura, retirado da parte dianteira do contrafilé', 79,  4);
insert into produto (nome, descricao, preco,  restaurante_id) values ('T-Bone', 'Corte muito saboroso, com um osso em formato de T, sendo de um lado o contrafilé e do outro o filé mignon', 89,  4);
...
values (1, '2cd5c869-2ed8-11f1-b491-d09466a69af8',1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
                    status, data_criacao, subtotal, taxa_frete, valor_total)
values (2, '2cd5c869-2ed8-11f1-b491-d09466a69ag9',4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
...
insert into usuario_restaurante values (1, 5, 1, 'COLABORADOR');
insert into usuario_restaurante values (2, 3, 2, 'COLABORADOR');
