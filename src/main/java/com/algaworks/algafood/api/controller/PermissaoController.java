...
public class PermissaoController {
    ...
    @PostMapping
    public ResponseEntity<PermissaoDTO> save(@RequestBody @Valid PermissaoInputDTO permissaoInputDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PermissaoDTO> update(@RequestBody @Valid PermissaoInputDTO permissaoInputDTO, @PathVariable Long id) {
